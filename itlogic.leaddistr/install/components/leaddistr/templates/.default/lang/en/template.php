...
Main advantages: speed of processing, convenient distribution, processing of all ice, uniform loading of employees";

$MESS["LEADDISTR_MODULE_INSTRUCTION_TITLE"] = "How to use this module:";
$MESS["LEADDISTR_MODULE_INSTRUCTION"] = "After the Administrator selects an employee who will receive all the new leads, they will be available to the other managers.";
$MESS["LEADDISTR_MODULE_INSTRUCTION_USER"] = "<b>To view the list of available leads, you must:</b> 
        <ul>
        <li>click on the button on the right (when you point it, the number of available leads is updated);</li>
        <li>when the \"LEADS\" button is pressed, a window with a list of leads opens and a \"Забрать\" button opposite each lead;</li>
        <li>when the \"Забрать\" button is pressed, the lead will disappear from the table and appear in your list on the crm page.</li>
        </ul>";

$MESS["LEADDISTR_MODULE_ADMIN_DESCRIPTION"] = "On this page, the Administrator can always choose a new person responsible for obtaining leads with the initial status. The visibility of leads by managers depends on the rights: <b> the minimum level in the settings </b> in columns <b>\"Read\" и \"Change\" </b> must be <b>\"Your + your department\"</b>.";
